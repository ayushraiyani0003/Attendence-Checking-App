            ...
            try {
                ...
                try {
                    ...
                    if (cachedData) {
                        ...
                        redisHasRecord = attendanceData.some(
                    ...
                    console.error(
                        `Error retrieving data from Redis for key ${redisKey}:`,
                        redisError
                    );
                }
                ...
                if (mysqlHasRecord && !redisHasRecord) {
                    ...
                    try {
                        ...
                        console.error(
                            `Failed to update Redis for key ${redisKey}:`,
                            redisSetError
                        );
                    }
                    continue;
                ...
                if (!mysqlHasRecord && redisHasRecord) {
                    ...
                    const redisRecord = attendanceData.find(
                        (record) => record.employee_id === employeeId
                    );
                    ...
                    await Attendance.create({
                        employee_id: employeeId,
                        attendance_date: formattedDate,
                        shift_type: redisRecord.shift_type || "GS",
