...
} = require("../controllers/reportingGroupController");
const {
...
// make a conns sadual for run the all attndence update as redis one in mysql. all attendence are update and update all status as lock status
