...
const AttendanceDateLockStatus = require("./attendanceDateLockStatus")(
    sequelize,
    Sequelize.DataTypes
);
...
const AttendanceChangeLog = require("./AttendanceChangeLog")(
    sequelize,
    Sequelize.DataTypes
);
const AttendanceUnlockRequest = require("./AttendanceUnlockRequest")(
    sequelize,
    Sequelize.DataTypes
);
