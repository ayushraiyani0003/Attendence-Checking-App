...
const VirtualizedTable = React.memo(
    ({ data, rowHeight = 50, containerRef, renderRow }) => {
...
function AttendancePage({
    ...
    const { registerInputRef, handleKeyDown } = useVerticalNavigation(
        filteredData,
        {
    ...
    const getEmployeeMetricsById = useCallback(
        (employeeId) => {
    ...
    useEffect(() => {
        ...
        const handleKeyDown = (e) => {
            ...
            if (
                isAltShift &&
                (e.code === "KeyS" || e.code === "KeyF" || e.code === "Space")
            ) {
                e.preventDefault();
        ...
        (row, index) => {
            ...
            return (
                <DataRow
                    ...
                    setPopupOpen={setCommentPopUpOpen}
                />
            );
        },
        [
